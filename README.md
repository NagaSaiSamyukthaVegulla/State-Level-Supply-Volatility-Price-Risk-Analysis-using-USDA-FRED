...
### Overview
This project implements an end-to-end data analytics pipeline to analyze US corn production, yield, harvested area, and market prices using official USDA datasets. The focus is on transforming raw agricultural data into business-ready insights to understand price risk, supply concentration, and yield efficiency over time.
...
- Removed inconsistencies and handled nulls
...
- Gold tables include:
  - **usda_corn_gold**: Year-level aggregates combining yield, production, area, and price
  - **usda_corn_gold_state_analysis**: State-wise yearly performance metrics
  - **usda_corn_state_risk**: Production and price volatility by state
  - **usda_corn_yield_efficiency**: Yield efficiency (bushels per acre)
...
- Dashboard design focuses on readability and decision-making
